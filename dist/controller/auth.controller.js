...
// export const loginHandler =(req:Request, res:
//     Response) =>{
// };
// export const registerHandler =async(req:Request, res:
//     Response) =>{
//         try{
// const newUser = req.body as unknown as User;
//  await prisma.user.create({
//     data:newUser
//  })
//  return res.status(201).json({
//     message: "welcom to the website !, user added !"
//  })
// }catch(error){
//     console.log(error);
//     const prismaError= error as PrismaClientInitializationError;
